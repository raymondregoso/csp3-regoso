...
//  A context object as the name states is a data is a data type of an object that can be used to store information that can be shared to other components withing the app
